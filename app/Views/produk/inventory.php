...
<div class="banner">
    <div class="banner-content">
        <div class="banner-text-content">
            <h1>Manajemen Inventori Terpadu untuk Semua Produk</h1>
                <p>Optimalkan Inventori dengan Sistem Coevo.</p>
...
<div class="tab">
    <div class="tab-layout">
        ...
        <button class="tablinks tablinks-active"><a href="<?= base_url('produk/inventory'); ?>"><img src="<?= base_url('image/inventory.png'); ?>" alt=""> <span>Inventory</span></a></button>
...
<div id="inventory" class="tabcontent">
    <div class="section-1-tab section-1-tab-left">
        ...
        <div class="tab-content-1 tab-content-left">
            <h2>Inventory</h2>
            <h4>Temukan kemudahan dalam mengelola inventori produk Anda:</h4>
            <ul>
                <li>Stok produk Anda diperbarui secara real-time di semua saluran penjualan, mengurangi risiko overstock atau stockout.</li>
                <li>Kelola seluruh inventori Anda dengan mudah, tanpa perlu berganti antar sistem.</li>
                <li>Melacak setiap barang masuk dan keluar dari gudang Anda dengan akurasi tinggi.</li>
                <li>Akses laporan mendetail tentang performa inventori.</li>
            </ul>
        </div>
    </div>
    <div class="section-2-tab section-2-tab-second">
        ...
        <div class="section-2-tab-layout-katalog">
            <div class="section-2-tab-box-katalog">
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan">
                        <span>Inventori Multichannel</span>
                    </div>
                    <p>Mengintegrasikan informasi stok produk secara otomatis di seluruh saluran penjualan.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-young">
                        <span>Dashboard Terpusat</span>
                    </div>
                    <p>Menggabungkan pemesanan dari berbagai saluran penjualan ke dalam satu dasbor pusat.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-old">
                        <span>Sistem Otomatis Reorder</span>
                    </div>
                    <p>Menyediakan algoritma otomatis untuk pengadaan barang berdasarkan tingkat stok minimum.</p>
                </div>
            </div>
            <div class="section-2-tab-box-katalog">
                <div class="icon-box-katalog">
            ...
            <div class="section-2-tab-box-katalog section-2-tab-box-katalog-right">
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan">
                        <span>Laporan Analisis Inventori</span>
                    </div>
                    <p>Laporan analisis inventori komprehensif, seperti perputaran stok dan nilai inventori.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-young">
                        <span>Retur dan Pengembalian</span>
                    </div>
                    <p>Fitur untuk pengelolaan proses retur dan pengembalian barang dengan efisien.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-old">
                        <span>Histori Perubahan Inventori</span>
                    </div>
                    <p>Merekam histori setiap perubahan dalam inventori, termasuk pembaruan stok, penambahan produk, atau perubahan harga.</p>
                </div>
            </div>
        </div>
    </div>
