...
<div class="banner">
    <div class="banner-content">
        <div class="banner-text-content">
            <h1>Pengelolaan Keuangan Bisnis yang Optimal</h1>
                <p>Optimalkan kontrol dan transparansi keuangan bisnis Anda melalui fitur pembukuan omnichannel Coevo, sehingga pengelolaan keuangan menjadi lebih efisien dan terorganisir.</p>
...
<div class="tab">
    <div class="tab-layout">
        ...
        <button class="tablinks tablinks-active"><a href="<?= base_url('produk/pembukuan'); ?>"><img src="<?= base_url('image/pembukuan.png'); ?>" alt=""> <span>Pembukuan</span></a></button>
...
<div id="inventory" class="tabcontent">
    <div class="section-1-tab section-1-tab-left">
        ...
        <div class="tab-content-1 tab-content-left">
            <h2>Pembukuan</h2>
            <h4>Optimalkan Proses Pembukuan untuk Bisnis Anda dengan Coevo:</h4>
            <ul>
                <li>Integrasi antara pemenuhan pesanan dari berbagai saluran penjualan dengan sistem pembukuan pusat.</li>
                <li>Pemrosesan Pesanan yang Tepat Waktu dalam Pembukuan.</li>
                <li>Peningkatan pembukuan melalui kategorisasi kurir dan pilihan jenis pengiriman pada setiap pemenuhan pesanan.</li>
                <li>Fasilitas manajemen retur dan klaim yang terintegrasi, memastikan proses pembukuan yang efisien untuk barang yang tidak terkirim.</li>
            </ul>
        </div>
    </div>
    <div class="section-2-tab section-2-tab-second">
        <h1>Fitur Pembukuan</h1>
        <p>Peningkatan Kinerja Bisnis Melalui Fitur Pembukuan Efisien dan Optimalisasi Stok.</p>
        <div class="section-2-tab-layout-katalog">
            <div class="section-2-tab-box-katalog">
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan">
                        <span>Integrasi Transaksi Otomatis</span>
                    </div>
                    <p>Meminimalkan kesalahan manual dan <br/>memastikan keakuratan data keuangan.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-young">
                        <span>Pemasukan dan Pengeluaran</span>
                    </div>
                    <p>Fasilitas untuk secara rinci melacak <br/>pemasukan dan pengeluaran bisnis.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-old">
                        <span>Laporan Keuangan Terpusat</span>
                    </div>
                    <p>Menyajikan laporan keuangan yang terpusat dan mudah diakses, memudahkan analisis performa keuangan bisnis.</p>
                </div>
            </div>
            <div class="section-2-tab-box-katalog">
                <div class="icon-box-katalog">
            ...
            <div class="section-2-tab-box-katalog section-2-tab-box-katalog-right">
                <div class="box-fitur-unggulan">
                    ...
                    <p>Menyajikan informasi keuangan dalam bentuk dashboard yang interaktif.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-young">
                        <span>Rasio Keuangan Otomatis</span>
                    </div>
                    <p>Menghitung rasio keuangan secara otomatis.</p>
                </div>
                <div class="box-fitur-unggulan">
                    <div class="heading-fitur-unggulan green-old">
                        <span>Proyeksi Real-time</span>
                    </div>
                    <p>Memungkinkan pengguna membuat proyeksi keuangan berdasarkan data real-time.</p>
                </div>
            </div>
        </div>
    </div>
